...
/**
 * Controlador para manejar la colocación inicial de ejércitos en las primeras fases del juego.
 */
@RestController
...
public class InitialPlacementController {
     ...
     */
    @GetMapping("/status")
    public ResponseEntity<InitialPlacementService.InitialPlacementStatus> getPlacementStatus(
            @PathVariable String gameCode) {

        try {
            InitialPlacementService.InitialPlacementStatus status =
    ...
    public ResponseEntity<InitialPlacementService.PlayerInitialStatus> getPlayerStatus(
            @PathVariable String gameCode,
            @PathVariable Long playerId) {

        try {
            InitialPlacementService.PlayerInitialStatus status =
    ...
    public ResponseEntity<PlayerTerritoriesDto> getPlayerTerritories(
        ...
        try {
            ...
            InitialPlacementService.PlayerInitialStatus playerStatus =
                    initialPlacementService.getPlayerStatus(gameCode, playerId);
